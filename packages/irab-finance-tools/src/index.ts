...
const rabyteModels = [
	...
	},
	{
		...
		maxTokens: 16_384,
		compat: { ...rabyteCompat, thinkingFormat: "deepseek" },
	},
	{
		id: "rabyte-gpt-5.4",
		name: "Rabyte GPT 5.4",
	...
	{
		id: "rabyte-gemini-2.5-pro",
		name: "Rabyte Gemini 2.5 Pro",
		reasoning: true,
		input: ["text", "image"],
		cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 },
	...
	{
		id: "rabyte-gemini-3.1-pro-preview",
		name: "Rabyte Gemini 3.1 Pro Preview",
		reasoning: true,
		input: ["text", "image"],
		cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 },
		contextWindow: 1_000_000,
